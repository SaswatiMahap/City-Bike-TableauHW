...
* Chosen time period for analysis: 201808

* How many trips have been recorded total during the chosen period? 
Count of Bikeid: 1,977,177
...
* SM: In the dashboard you can see the peak hours in the month of August 2018

17th and the 18th hour 


* Today, what are the top 10 stations in the city for starting a journey? (Based on data, why do you hypothesize these are the top locations?)
* Refer tab "Top 10 Starting Stations" based on Bikeid count or number of records 

* Today, what are the top 10 stations in the city for ending a journey? (Based on data, why?)
*  Refer Tab "Top Ending stations" based on Bikeid count or number of records 

* Today, what are the bottom 10 stations in the city for starting a journey? (Based on data, why?)
*Refer Tab "Bottom Starting Stations"

* Today, what are the bottom 10 stations in the city for ending a journey (Based on data, why?)
 Refer Tab "Bottm ending stations"
